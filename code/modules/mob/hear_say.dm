...
/mob/proc/hear_say(var/message, var/verb = "says", var/datum/language/language = null, var/alt_name = "",var/italics = 0, var/mob/speaker = null, var/sound/speech_sound, var/sound_vol)
	...
	if(is_deaf())
		...
		if(language)
			var/nverb = null
			if(!say_understands(speaker,language) || language.name == LANGUAGE_RUNGLISH) //Check to see if we can understand what the speaker is saying. If so, add the name of the language after the verb. Don't do this for Galactic Common.
...
/mob/proc/hear_radio(var/message, var/verb="says", var/datum/language/language=null, var/part_a, var/part_b, var/part_c, var/mob/speaker = null, var/hard_to_hear = 0, var/vname ="")
	...
	var/formatted
	if(language)
		if(!say_understands(speaker,language) || language.name == LANGUAGE_RUNGLISH) //Check if we understand the message. If so, add the language name after the verb. Don't do this for Galactic Common.
